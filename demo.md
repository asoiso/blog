...
<p>Since one file can be published to multiple locations, you can list and manage publish locations by clicking <strong>File publication</strong> in the <strong>Publish</strong> sub-menu. This <strong>allows</strong> you to list and <strong>remove</strong> publication locations that are linked to your file.</p>
